...
export async function getDiscoverMovies() {
    const {
        data: { results } } = await api.get('/discover/movie')
...
export async function getUpcomingMovies() {
    const {
        data: { results } } = await api.get('/movie/upcoming')
...
export async function getAiringTodaySeries() {
    const {
        data: { results } } = await api.get('/tv/airing_today')
...
export async function getOnTheAirSeries() {
    const {
        data: { results } } = await api.get('/tv/on_the_air')
